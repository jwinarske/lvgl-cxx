...
// Style properties mirror lv_theme_default.c / lv_theme_mono.c from LVGL v9.5.0.
...
Color Theme::primary_color()   const noexcept { return Color::Blue(); }
Color Theme::secondary_color() const noexcept { return Color::White(); }
Color Theme::fg_color()        const noexcept { return Color::Black(); }
Color Theme::bg_color()        const noexcept { return Color::White(); }
...
DefaultTheme::DefaultTheme(Color primary, Color secondary) noexcept
    ...
    style_base_
        ...
        .set(prop::BorderColor{},     Color::from_hex(0xBDBDBD))  // grey-400
    ...
    // ── Focused state style ───────────────────────────────────────────────────
    style_focused_
        .set(prop::OutlineColor{},   primary_)
...
Color DefaultTheme::primary_color()   const noexcept { return primary_;   }
Color DefaultTheme::secondary_color() const noexcept { return secondary_; }
Color DefaultTheme::fg_color()        const noexcept { return Color::Black(); }
Color DefaultTheme::bg_color()        const noexcept { return Color::White(); }
...
Color MonoTheme::primary_color()   const noexcept { return Color::Black(); }
Color MonoTheme::secondary_color() const noexcept { return Color::White(); }
Color MonoTheme::fg_color()        const noexcept { return Color::Black(); }
Color MonoTheme::bg_color()        const noexcept { return Color::White(); }
