...
TEST(ObjFlags, AllBitsIndependent) {
  ...
  ObjFlags all =
      ObjFlags::Hidden | ObjFlags::Clickable | ObjFlags::ClickFocusable |
      ...
      ObjFlags::OverflowVisible | ObjFlags::EventTrickle |
      ObjFlags::StateTrickle | ObjFlags::User1 | ObjFlags::User2 |
      ObjFlags::User3 | ObjFlags::User4;
...
TEST(ObjState, AllNamedStatesOrToAny) {
  ...
  auto all = ObjState::Checked | ObjState::Focused | ObjState::FocusKey |
             ...
             ObjState::Scrolled | ObjState::Disabled | ObjState::User1 |
             ObjState::User2 | ObjState::User3 | ObjState::User4;
...
TEST(Dir, AllIsBitOrOfAll) {
  EXPECT_EQ(static_cast<uint8_t>(Dir::All),
            static_cast<uint8_t>(Dir::Left) | static_cast<uint8_t>(Dir::Right) |
                static_cast<uint8_t>(Dir::Top) |
                static_cast<uint8_t>(Dir::Bottom));
}
