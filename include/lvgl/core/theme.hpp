...
class Theme {
 public:
  ...
  /// Primary color used by the theme (buttons, focus rings, etc.)
...
// ── MonoTheme
// ───────────────────────────────────────────────────────────────── Pure
// black/white palette, suitable for 1-bit and grayscale displays. Mirrors
// lv_theme_mono in LVGL v9.5.0 (src/themes/mono/lv_theme_mono.c).
//
// Applied styles:
